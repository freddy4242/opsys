...
// Define interrupt service routine (ISR) numbers for CPU exceptions.
#define ISR1 1
#define ISR2 2
#define ISR3 3
#define ISR4 4
...
// Define interrupt request (IRQ) numbers for hardware interrupts.
#define IRQ0 32
#define IRQ1 33
#define IRQ2 34
#define IRQ3 35
...
// Functions to initialize interrupts and IRQs
void init_irq();
void init_interrupts();

// Struct for holding register values during interrupts
...
// Arrays to hold registered interrupt and IRQ handlers
